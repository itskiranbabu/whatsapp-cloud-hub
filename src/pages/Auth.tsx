...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-background via-background to-primary/5">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-12 flex-col justify-between">
        <motion.div 
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-md">
            Engage customers at scale with automated messaging, AI-powered chatbots, and comprehensive analytics.
          </p>
        ...
        >
          © 2026 WhatsApp API Platform. All rights reserved.
        </motion.p>
      </div>
